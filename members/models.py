...
class Members(models.Model):
    ...
    baptism = models.DateTimeField(auto_now=False, auto_now_add=True, null=True)
    sacrament = models.DateTimeField(auto_now=False, auto_now_add=True, null=True)
    ...
    engagement = models.DateTimeField(auto_now=False, auto_now_add=True, null=True)
    marriage = models.DateTimeField(auto_now=False, auto_now_add=True, null=True)
